...
export const Signup = ()=>{
    return <Card className="flex justify-center items-center w-100 h-100" >
        ...
        <p className=" text-[#f4f1ce] mt-5 self-center text-xl font-bold " >Signup</p>
    <form className=" p-5 flex flex-col gap-2" >
        <input name="firstName" className="focus:border-[#fe9833] focus:outline focus:outline-[#fe9833] rounded-md p-2 text-[#f4f1ce] bg-black border border-neutral-700"  type="text" placeholder="First Name" />
        <input  name="lastName"  className="focus:border-[#fe9833] focus:outline focus:outline-[#fe9833] rounded-md p-2 text-[#f4f1ce] bg-black border border-neutral-700" placeholder="Last Name"/>
